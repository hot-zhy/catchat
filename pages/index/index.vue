<template>
	<view class="content">
		<uni-nav-bar :fixed="true" status-bar background-color="#FEE2D5">
			<block>
				<view class="d-flex a-center">
					<view class="left d-flex">
						<image src="/static/cat_two.png" mode="widthFix" style="width: 100rpx"></image>
					</view>
					<view style="margin-left: 40rpx; font-size: 40rpx;font-weight: 600;">喵喵聊</view>
				</view>
			</block>
		</uni-nav-bar>
			...
			<view v-for="(item,index) in arr" :key="index">
				<view class="body_l" v-if="item.type == 1">
					<view class="body_lpic a">
						<image src="/static/cat_two.png" mode=""></image>
					</view>
					<view class="body_box">
						<view class="body_jt">
		...
		<view class="flooer">
			<!--  #endif -->
			<!--  #ifdef  H5 -->
			<view class="flooer" style="margin-bottom: 120rpx;">
				<!--  #endif -->
				<view class="flooer_l">
			...
			<!-- <view class="pix_box" v-if="pix_box"></view> -->
	...
	export default {
		data() {
			return {
				...
				vals: '',
				retext: 'key', //从chatgpt官网获取key并在这里配置
				pix_box: false,
				timer: null,
				wen: '',
